      ...
      <div className="px-3 py-4 border-t border-gray-100">
        ...
        <div className="flex items-center gap-3 px-3 py-3 mt-2 rounded-xl bg-gray-50">
          <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center">
            <span className="text-primary font-semibold text-xs">ICB</span>
          </div>
          <div className="flex-1 min-w-0">
            <div className="text-sm font-medium text-gray-900 truncate">ICB Store</div>
            <div className="text-xs text-gray-500 truncate">admin@icb.com</div>
          </div>
        </div>
      </div>
    </aside>
